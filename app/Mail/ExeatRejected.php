...
class ExeatRejected extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: '❌ Exeat Request Rejected - ' . $this->exeat->student->full_name,
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.parent.exeat-rejected',
            with: [
                'exeat' => $this->exeat,
