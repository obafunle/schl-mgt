    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Teacher Timetable') }} - {{ $teacher->full_name }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                    <div>
                        <span class="font-semibold">Teacher:</span> {{ $teacher->full_name }}
                        <span class="ml-4 font-semibold">Term:</span> {{ $term->name }}
                    </div>
                    <div>
                        <span class="text-sm text-gray-500">Total Classes: {{ $timetable['entries']->count() }}</span>
                    </div>
                </div>
