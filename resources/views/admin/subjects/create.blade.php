                    ...
                    <form action="{{ route('admin.subjects.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="number" id="weekly_hours" name="weekly_hours" value="{{ old('weekly_hours', 4) }}"
                                       min="1" max="40"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                @error('weekly_hours')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" id="exam_weight" name="exam_weight" value="{{ old('exam_weight', 60) }}"
                            ...
                            <div>
                                ...
                                <input type="number" id="ca_weight" name="ca_weight" value="{{ old('ca_weight', 40) }}"
                                       min="0" max="100" required
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                @error('ca_weight')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="flex items-center justify-end pt-4 mt-6 space-x-3 border-t border-gray-200">
                            ...
                            <button type="submit"
                                    style="display: inline-flex; align-items: center; padding: 8px 24px; font-size: 14px; font-weight: 600; color: #ffffff; background-color: #059669; border: none; border-radius: 6px; cursor: pointer; transition: all 0.2s ease;"
                                    onmouseover="this.style.backgroundColor='#047857'; this.style.transform='scale(1.02)'"
